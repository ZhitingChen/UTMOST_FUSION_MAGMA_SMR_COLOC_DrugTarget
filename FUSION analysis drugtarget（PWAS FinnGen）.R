...
#### EA ####
# step1. -----------------------------------------------------------
prepare_sumstat <- data.table::fread("F:/post-GWAS/data_gwas_list/data_prepare/fusion/finngen_R10_C3_BREAST_EXALLC.sumstats",
                                     data.table = F)
...
fusion_assoc(sumstat_data = prepare_sumstat,
             ...
             out_prefix = "Breast_cancer_FinnGen_PWAS" )
...
write.csv(res_fusion,file = "E:/post_gwas_cancer/tmp/PWAS/Breast_cancer_FinnGen_PWAS_summary_p_fdr.csv")
write.csv(res_fusion_f,file = "E:/post_gwas_cancer/tmp/PWAS/Breast_cancer_FinnGen_PWAS_summary_p_fdr_filtered.csv")

# step2. -----------------------------------------------------------
prepare_sumstat <- data.table::fread("F:/post-GWAS/data_gwas_list/data_prepare/fusion/finngen_R10_C3_BREAST_ERNEG_EXALLC.sumstats",
                                     data.table = F)
...
fusion_assoc(sumstat_data = prepare_sumstat,
             ...
             ref_ld_chr_num = 1:22,
             out_path = "E:/post_gwas_cancer/tmp/PWAS/",
             out_prefix = "ER-_Breast_cancer_FinnGen_PWAS" )
...
write.csv(res_fusion,file = "E:/post_gwas_cancer/tmp/PWAS/ER-_Breast_cancer_FinnGen_PWAS_summary_p_fdr.csv")
write.csv(res_fusion_f,file = "E:/post_gwas_cancer/tmp/PWAS/ER-_Breast_cancer_FinnGen_PWAS_summary_p_fdr_filtered.csv")

# step3. -----------------------------------------------------------
prepare_sumstat <- data.table::fread("F:/post-GWAS/data_gwas_list/data_prepare/fusion/finngen_R10_C3_BREAST_ERPLUS_EXALLC.sumstats",
                                     data.table = F)
